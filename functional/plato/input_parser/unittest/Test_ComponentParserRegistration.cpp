...
PLATO_INPUT_BLOCK_STRUCT((plato)(input_parser),
                         ...
                         plato::components::ComponentType::kFilter,
                         (int, dark_roast, "no comment"))
...
TEST(ComponentParserRegistration, BlockNamesOfComponentType)
{
    ...
    {
        const auto tGeometryNames = all_block_names_with_component_type<components::ComponentType::kGeometry>();
    ...
    }
    {
        ...
        const auto tFilterNames = all_block_names_with_component_type<components::ComponentType::kFilter>();
