...
{
    static const auto tBuildPath = std::filesystem::path{"@FUNCTIONAL_DATA_BUILD_PATH@"};
    static const auto tInstallPath = std::filesystem::path{"@FUNCTIONAL_DATA_INSTALL_PATH@"};
