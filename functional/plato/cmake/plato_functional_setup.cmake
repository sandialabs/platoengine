...
macro(create_unittest_pch_target)
    add_library(UnitTestPCHInterface INTERFACE)
    target_precompile_headers(UnitTestPCHInterface INTERFACE "<gtest/gtest.h>")
endmacro(create_unittest_pch_target)
