...
auto make_penalty_dynamic_vector_function(const test_utilities::Penalty& aPenalty)
...
{
    return core::make_function_with_first_derivative([p = aPenalty](const linear_algebra::DynamicVector<double>& x)
