...
void test_constraint_type_and_value(
    const criteria::library::VectorConstraint<const mesh::MeshDesignVariables&>& aConstraint,
...
criteria::library::VectorConstraint<const mesh::MeshDesignVariables&> get_first_constraint(
