...
void checkLogMessage(const third_party_integration::boost_log::Severity aSeverity,
...
{
    checkLogMessage(third_party_integration::boost_log::Severity::kDebug,
                    std::mem_fn(&ComponentLogger::logDebugMessage), TEST_CONTEXT("Debug log member"));
    checkLogMessage(third_party_integration::boost_log::Severity::kInfo, std::mem_fn(&ComponentLogger::logInfo),
                    TEST_CONTEXT("Info log member"));
    checkLogMessage(third_party_integration::boost_log::Severity::kWarning, std::mem_fn(&ComponentLogger::logWarning),
                    TEST_CONTEXT("Warning log member"));
    checkLogMessage(third_party_integration::boost_log::Severity::kError, std::mem_fn(&ComponentLogger::logError),
