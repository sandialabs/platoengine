...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void PlatoKrinoInterface::generate_bounding_box_mesh(krino::BoundingBoxMesh &bboxMesh,
...
void PlatoKrinoInterface::fill_node_ids_for_nodes(const stk::mesh::BulkData &mesh,
...
void PlatoKrinoInterface::fill_d_coords_d_levelsets(
    const krino::FieldRef coordsField,
...
stk::mesh::Selector PlatoKrinoInterface::build_output_selector(const stk::mesh::MetaData &meta,
...
std::map<stk::mesh::EntityId, InterfaceNode_DXDP> PlatoKrinoInterface::get_levelset_shape_sensitivities(
    const stk::mesh::BulkData &mesh, const krino::FieldRef levelSetField)
{
    ...
    for (auto &stencil : childNodeStencils)
    {
        ...
        fill_d_coords_d_levelsets(coordsField, levelSetField, stencil.parentNodes,
                                                               ...
                                                               const std::string &filename)
{
    ...
    krino::output_composed_mesh_with_fields(
        bboxMesh.bulk_data(), krino::AuxMetaData::get(bboxMesh.meta_data()).active_part(), filename, 1, 0.0);
}

void PlatoKrinoInterface::initialize_levelset_field_for_plane(const stk::mesh::BulkData &mesh,
...
void PlatoKrinoInterface::initialize_levelset_field_for_spheres(
...
void PlatoKrinoInterface::initialize_levelset_fields_from_primitives(const stk::mesh::BulkData &mesh,
                                                                     krino::FieldRef levelSetField,
                                                                     const LevelsetPrimitives &aLevelsetPrimitives)
{
    const krino::FieldRef coordsField = mesh.mesh_meta_data().coordinate_field();
...
void PlatoKrinoInterface::decompose_mesh_to_conform_to_levelsets(stk::mesh::BulkData &mesh,
...
void PlatoKrinoInterface::create_bounding_box_mesh(const double &aXMin,
                                                   const double &aYMin,
                                                   const double &aZMin,
                                                   const double &aXMax,
                                                   const double &aYMax,
...
{
    stk::mesh::Selector outputSelector = build_output_selector(
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void PlatoKrinoInterface::cutMesh() { decompose_mesh_to_conform_to_levelsets(*mBulkData, mLSFields); }

void PlatoKrinoInterface::initializePlaneLevelset(const double &aNormalX,
...
void PlatoKrinoInterface::createBoundingBoxMesh(const double &aXMin,
                                                const double &aYMin,
                                                const double &aZMin,
                                                const double &aXMax,
                                                const double &aYMax,
...
void PlatoKrinoInterface::writeMesh(const std::string &aFilename) { write_mesh(aFilename); }

std::unordered_map<unsigned int, stk::math::Vector3d>
PlatoKrinoInterface::predictNewCoordinatesBasedOnPerturbedLevelsetValues(
...
void PlatoKrinoInterface::resetMesh() { krino::CDMesh::reset_mesh_to_original_undecomposed_state(*mBulkData); }
