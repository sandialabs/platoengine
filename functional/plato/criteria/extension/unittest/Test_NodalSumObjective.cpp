...
TEST(NodalSumObjective, Value111)
{
    ...
    EXPECT_EQ(NodalSumObjective{}.f(mesh::MeshDesignVariables{kTestFile, {}}), tExpectedValue);
...
TEST(NodalSumObjective, Gradient111)
{
    ...
    const std::vector tComputed = tNodalSum.df(mesh::MeshDesignVariables{kTestFile, {}}).stdVector();
...
TEST(NodalSumObjective, Value)
{
    ...
    mesh::MeshDesignVariables tMeshDesignVariables{kBrickFile, {}};
