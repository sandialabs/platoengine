...
class CriterionInterface
{
   public:
    ...
    virtual double value(const design_variables::MeshDesignVariables& aMeshDesignVariables) const = 0;
    virtual std::vector<double> gradient(const design_variables::MeshDesignVariables& aMeshDesignVariables) const = 0;
