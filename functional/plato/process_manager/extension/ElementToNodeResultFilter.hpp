...
[[nodiscard]] auto validate_geometry_is_density_topology(const input_parser::element_to_node_result_filter& aInput)
    -> std::optional<std::string>;
    ...
    const boost::optional<input_parser::CrossReference<kComponentType>>& aCrossReference) -> std::optional<std::string>
{
    ...
    {
        return std::optional<std::string>{input_parser::block_name<input_parser::element_to_node_result_filter>() +
