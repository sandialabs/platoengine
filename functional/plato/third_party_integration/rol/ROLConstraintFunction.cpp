...
{
    const double tConstraintValue = mFunction.evaluate<core::evaluation::kFunction>(to_dynamic_vector(aControl));
...
void ROLConstraintFunction::applyJacobian(ROL::Vector<double>& aJacobianTimesDirection,
                                          ...
                                          double& /*aTolerance*/)
{
    const double tJacobianTimesDirection =
        mFunction.evaluate<core::evaluation::kFirstDerivative>(to_dynamic_vector(aControl))
                                                 ...
                                                 double& /*aTolerance*/)
{
    ...
    auto tAdjointJacobianTimesDirection =
        mFunction.evaluate<core::evaluation::kFirstDerivative>(to_dynamic_vector(aControl));
