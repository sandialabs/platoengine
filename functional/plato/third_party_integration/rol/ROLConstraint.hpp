...
{
/// @brief Types of constraints that ROL supports
...
[[nodiscard]] auto create_inequality_bounds(ConstraintType aType,
                                            unsigned int aNumberOfConstraints) -> ROL::Ptr<ROL::Bounds<double>>;
