...
[[nodiscard]] auto mpi_root_rank_filter(const boost::mpi::communicator& aCommunicator) -> boost::log::filter;

constexpr inline auto kMPIRankAttributeName = std::string_view{"MPI rank"};
}  // namespace plato::third_party_integration::boost_log

BOOST_LOG_ATTRIBUTE_KEYWORD(mpi_rank, plato::third_party_integration::boost_log::kMPIRankAttributeName.data(), int)
