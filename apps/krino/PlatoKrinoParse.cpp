...
bool parseCommandLineOptions(int aArgc, char *aArgv[], CommandLineOptions &aCommandLineOptions)
{
    ...
    tCLP.setOption("bg_mesh", &(aCommandLineOptions.mBackgroundMeshName), "Name of static background mesh that will hold levelset values.");
    tCLP.setOption("cut_mesh", &(aCommandLineOptions.mCutMeshName), "Name of mesh that is cut out of the background mesh using levelset values.");
